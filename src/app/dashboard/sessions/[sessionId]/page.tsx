                ...
                <Card className="md:col-span-2">
                    <CardHeader>
                        <CardTitle className="flex items-center justify-between">
                            Session Status
                            <div className={`px-3 py-1 rounded-full text-xs font-bold ${session.status === 'CONNECTED' ? 'bg-pink-100 text-pink-700' :
                            ...
                            <div className="mt-4 pt-4 border-t">
                                ...
                                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                                    <div className="bg-slate-50 p-3 rounded border text-center relative overflow-hidden">
                                        ...
                                        <div className="font-bold text-pink-600 mt-1">{systemMetrics.ping}</div>
                                    </div>
