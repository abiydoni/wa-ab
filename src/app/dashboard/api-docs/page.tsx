...
export default function ApiDocsPage() {
    ...
    const getMethodColor = (method: string) => {
        switch (method) {
            case "GET": return "bg-pink-100 text-pink-800 border-pink-300";
                ...
                <div className="bg-white rounded-lg shadow p-6 mb-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <a
                            ...
                            className="flex items-center p-4 border rounded-lg hover:bg-gray-50 transition-colors group"
                        >
                            <FileText className="w-10 h-10 text-pink-600 mr-4" />
                            <div className="flex-1">
                                <h3 className="font-medium text-gray-800 group-hover:text-pink-600">OpenAPI Spec</h3>
