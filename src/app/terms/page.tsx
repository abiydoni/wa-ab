...
export const metadata = {
    title: "Terms of Service | WA-AB",
    description: "Terms of Service and Usage Guidelines for WA-AB.",
};
...
export default function TermsPage() {
    return (
        <div className="min-h-screen bg-background relative overflow-hidden py-24 selection:bg-primary/30 selection:text-primary-foreground">
            ...
            <div className="fixed top-0 left-1/4 -translate-x-1/2 -translate-y-1/2 w-[40rem] h-[40rem] bg-pink-500/5 dark:bg-pink-500/10 rounded-full blur-[120px] pointer-events-none -z-10" />
                ...
                <div className="glass-panel p-8 md:p-12 rounded-3xl shadow-xl shadow-black/5 dark:shadow-black/20 animate-in fade-in slide-in-from-bottom-8 duration-700">
                    ...
                    <div className="prose prose-slate dark:prose-invert max-w-none prose-headings:font-bold prose-headings:tracking-tight prose-a:text-primary hover:prose-a:text-primary/80 prose-p:leading-relaxed">
                        ...
                        <p className="lead text-lg text-muted-foreground mb-8">
                            Welcome to WA-AB. By accessing or using our WhatsApp Gateway platform, you agree to be bound by these Terms. If you do not agree, please do not use the service.
                        </p>
                        ...
                        <p>
                            Security forms the core of our service. As a self-hosted platform, WA-AB ensures that your data remains strictly within your own infrastructure.
                        </p>
                        <ul>
                        ...
                        <p>
                            When utilizing WA-AB's API, auto-replies, and broadcasting capabilities, you agree to abide by WhatsApp's official Terms of Service and Anti-Spam policies. You agree not to:
                        </p>
                        <ul>
