...
export const metadata = {
    title: "Privacy Policy | WA-AB",
    description: "Privacy Policy and Data Handling for WA-AB.",
};
...
export default function PrivacyPage() {
    return (
        <div className="min-h-screen bg-background relative overflow-hidden py-24 selection:bg-primary/30 selection:text-primary-foreground">
            ...
            <div className="fixed bottom-0 left-1/4 -translate-x-1/2 translate-y-1/2 w-[30rem] h-[30rem] bg-pink-500/5 dark:bg-pink-600/10 rounded-full blur-[100px] pointer-events-none -z-10" />
                ...
                <div className="glass-panel p-8 md:p-12 rounded-3xl shadow-xl shadow-black/5 dark:shadow-black/20 animate-in fade-in slide-in-from-bottom-8 duration-700">
                    ...
                    <div className="prose prose-slate dark:prose-invert max-w-none prose-headings:font-bold prose-headings:tracking-tight prose-a:text-primary hover:prose-a:text-primary/80 prose-p:leading-relaxed">
                        ...
                        <p className="lead text-lg text-muted-foreground mb-8">
                            At WA-AB, we believe that your data is your property. This Privacy Policy details the strict boundaries regarding how information is handled when using our open-source, self-hosted WhatsApp Gateway.
                        </p>
                        ...
                        <p>
                            Because WA-AB is designed to be <strong>self-hosted</strong>, all core data processing occurs exclusively on the hardware where you deploy the application.
                        </p>
                        <ul>
                            <li><strong>No Centralized Telemetry:</strong> The creators of WA-AB do not receive telemetry, analytics, or usage reports about your WhatsApp interactions.</li>
                        ...
                        <ul>
                            ...
                            <li><strong>WhatsApp Sessions:</strong> WA-AB acts as a bridge to WhatsApp Web. The session tokens (keys) necessary to maintain this connection are stored locally on your server.</li>
                        ...
                        <p>
                            While WA-AB is built with modern security practices, the ultimate safety of your data depends on your hosting environment. We strongly recommend:
                        </p>
                        <ul>
                        ...
                        <p>
                            WA-AB utilizes the <code>@whiskeysockets/baileys</code> library to communicate directly with WhatsApp's servers. By using this gateway, your server will establish a direct web-socket connection to WhatsApp. Please be aware that your use of WhatsApp is still subject to Meta's Privacy Policy.
                        </p>
                        ...
                        <div className="mt-12 p-6 bg-blue-500/5 rounded-2xl border border-blue-500/10">
                            ...
                            <p className="text-sm text-muted-foreground mb-0">If you have specific questions about data handling or wish to audit the code, please visit our <Link href="https://github.com/mrifqidaffaaditya/WA-AB">GitHub Repository</Link>.</p>
                        </div>
                    </div>
                </div>
            </div>
