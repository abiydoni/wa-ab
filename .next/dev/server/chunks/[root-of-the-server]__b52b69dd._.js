...
"[project]/src/app/api/sessions/[sessionId]/access/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const grantAccessSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
...
const revokeAccessSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    userId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1, "User ID is required")
});
async function GET(request, { params }) {
    try {
        ...
        const isOwner = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isSessionOwner"])(user.id, user.role, sessionId);
        if (!isOwner) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: false,
                message: "Forbidden - Only session owner can manage access"
            }, {
                status: 403
            });
        }
        ...
        const accessList = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].sessionAccess.findMany({
            where: {
                sessionId: dbSession.id
            },
            include: {
...
async function POST(request, { params }) {
    try {
        ...
        if (targetUser.id === dbSession.userId) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: false,
                message: "Cannot grant access to the session owner"
            }, {
                status: 400
            });
        }
        ...
        if (targetUser.role === "SUPERADMIN") {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: false,
                message: "SUPERADMIN already has access to all sessions"
            }, {
                status: 400
            });
        }
        // Check if access already exists
        const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].sessionAccess.findUnique({
            where: {
                sessionId_userId: {
                    sessionId: dbSession.id,
        ...
        // Create access
        const access = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].sessionAccess.create({
            data: {
                sessionId: dbSession.id,
                userId: targetUser.id
            },
...
async function DELETE(request, { params }) {
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].sessionAccess.delete({
            where: {
                id: existing.id
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b52b69dd._.js.map