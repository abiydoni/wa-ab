...
async function POST(req) {
    ...
    if (user?.role !== "SUPERADMIN") {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: false,
            message: "Forbidden: Only Superadmin can send notifications",
            error: "Forbidden"
        }, {
            status: 403
        });
    ...
    try {
        ...
        if (broadcast) {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].notification.createMany({
                data: notifications
            });
            // Emit Socket.IO event for each user
            const io = /*TURBOPACK member replacement*/ __turbopack_context__.g.io;
            if (io) {
                allUsers.forEach((u)=>{
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ...
            error: "Provide targetUserId or broadcast=true"
        }, {
            status: 400
        });
    } catch (e) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e622f4af._.js.map