...
const execSync = __turbopack_context__.r("[externals]/child_process [external] (child_process, cjs)").execSync;
...
function getVboxmanage() {
    return ("TURBOPACK compile-time truthy", 1) ? `"${process.env.VBOX_INSTALL_PATH || process.env.VBOX_MSI_INSTALL_PATH}\\VBoxManage.exe"` : "TURBOPACK unreachable";
}
        ...
        return new Promise((resolve)=>{
            process.nextTick(()=>{
                try {
                    ...
                    const spanOptions = osVersion[0] < 10 ? [
                        '-NoProfile',
                        '-NoLogo',
                        '-InputFormat',
                        'Text',
...
function checkWebsite(url, timeout = 5000) {
    const http = url.startsWith('https:') || url.indexOf(':443/') > 0 || url.indexOf(':8443/') > 0 ? __turbopack_context__.r("[externals]/https [external] (https, cjs)") : __turbopack_context__.r("[externals]/http [external] (http, cjs)");
    const t = Date.now();
    return new Promise((resolve)=>{
...
"[project]/node_modules/systeminformation/lib/osinfo.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const os = __turbopack_context__.r("[externals]/os [external] (os, cjs)");
const fs = __turbopack_context__.r("[externals]/fs [external] (fs, cjs)");
const util = __turbopack_context__.r("[project]/node_modules/systeminformation/lib/util.js [app-route] (ecmascript)");
const exec = __turbopack_context__.r("[externals]/child_process [external] (child_process, cjs)").exec;
const execSync = __turbopack_context__.r("[externals]/child_process [external] (child_process, cjs)").execSync;
const _platform = process.platform;
const _linux = _platform === 'linux' || _platform === 'android';
...
function osInfo(callback) {
    return new Promise((resolve)=>{
        process.nextTick(()=>{
            let result1 = {
                platform: ("TURBOPACK compile-time truthy", 1) ? 'Windows' : "TURBOPACK unreachable",
                distro: 'unknown',
                release: 'unknown',
                codename: '',
                kernel: os.release(),
            ...
            if ("TURBOPACK compile-time truthy", 1) {
                ...
                try {
                    ...
                    util.promiseAll(workload).then((data)=>{
                        ...
                        result1.distro = util.getValue(lines, 'Caption', ':').trim();
                        result1.serial = util.getValue(lines, 'SerialNumber', ':').trim();
                        result1.build = util.getValue(lines, 'BuildNumber', ':').trim();
                        result1.servicepack = util.getValue(lines, 'ServicePackMajorVersion', ':').trim() + '.' + util.getValue(lines, 'ServicePackMinorVersion', ':').trim();
                        result1.codepage = util.getCodepage();
                        const hyperv = data.results[1] ? data.results[1].toString().toLowerCase() : '';
                        result1.hypervisor = hyperv.indexOf('true') !== -1;
                        const term = data.results[2] ? data.results[2].toString() : '';
                        if (data.results[3]) {
                            const codenameParts = data.results[3].split('REG_SZ');
                            result1.codename = codenameParts.length > 1 ? codenameParts[1].trim() : '';
                        }
                        if (!result1.codename) {
                            const buildNum = parseInt(result1.build, 10);
                            result1.codename = getWindowsRelease(buildNum);
                        }
        ...
        process.nextTick(()=>{
            ...
            if ("TURBOPACK compile-time truthy", 1) {
                ...
                util.powerShell('Get-CimInstance Win32_ComputerSystemProduct | select UUID | fl').then((stdout)=>{
                    ...
                    result1.hardware = util.getValue(lines, 'uuid', ':').toLowerCase();
                    exec(`${sysdir}\\reg query "HKEY_LOCAL_MACHINE\\SOFTWARE\\Microsoft\\Cryptography" /v MachineGuid`, util.execOptsWin, (error, stdout)=>{
                        ...
                        result1.os = parts.length > 1 ? parts[1].replace(/\r+|\n+|\s+/gi, '').toLowerCase() : '';
                        if (callback) {
                            callback(result1);
                        }
                        resolve(result1);
...
"[project]/node_modules/systeminformation/lib/system.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const os = __turbopack_context__.r("[externals]/os [external] (os, cjs)");
const util = __turbopack_context__.r("[project]/node_modules/systeminformation/lib/util.js [app-route] (ecmascript)");
const { uuid } = __turbopack_context__.r("[project]/node_modules/systeminformation/lib/osinfo.js [app-route] (ecmascript)");
const exec = __turbopack_context__.r("[externals]/child_process [external] (child_process, cjs)").exec;
const execSync = __turbopack_context__.r("[externals]/child_process [external] (child_process, cjs)").execSync;
const execPromise = util.promisify(__turbopack_context__.r("[externals]/child_process [external] (child_process, cjs)").exec);
const _platform = process.platform;
const _linux = _platform === 'linux' || _platform === 'android';
const _darwin = _platform === 'darwin';
const _windows = _platform === 'win32';
...
"[project]/node_modules/systeminformation/lib/cpu.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/systeminformation/lib/memory.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/systeminformation/lib/battery.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/systeminformation/lib/graphics.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
function graphics(callback) {
    ...
    function getNvidiaSmi() {
        ...
        if ("TURBOPACK compile-time truthy", 1) {
            try {
                ...
                const candidates = fs.readdirSync(basePath, {
                    withFileTypes: true
    ...
    function nvidiaSmi(options) {
        ...
        if (nvidiaSmiExe) {
            ...
            ;
            try {
                const sanitized = cmd + (("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : '') + (("TURBOPACK compile-time truthy", 1) ? '  2> nul' : "TURBOPACK unreachable");
...
"[project]/node_modules/systeminformation/lib/filesystem.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const exec = __turbopack_context__.r("[externals]/child_process [external] (child_process, cjs)").exec;
const execSync = __turbopack_context__.r("[externals]/child_process [external] (child_process, cjs)").execSync;
const execPromiseSave = util.promisifySave(__turbopack_context__.r("[externals]/child_process [external] (child_process, cjs)").exec);
const _platform = process.platform;
const _linux = _platform === 'linux' || _platform === 'android';
const _darwin = _platform === 'darwin';
const _windows = _platform === 'win32';
        ...
        lines.forEach((line)=>{
            if (line !== '') {
                ...
                if (line && (line[0].startsWith('/') || line[6] && line[6] === '/' || line[0].indexOf('/') > 0 || line[0].indexOf(':') === 1 || !_darwin && !isLinuxTmpFs(line[1]))) {
                    const fs = line[0];
                    const fsType = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : getmacOsFsType(line[0]);
                    const size = parseInt(("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : line[1], 10) * 1024;
                    const used = parseInt(("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : line[2], 10) * 1024;
                    const available = parseInt(("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : line[3], 10) * 1024;
                    const use = parseFloat((100.0 * (used / (used + available))).toFixed(2));
                    const rw = osMounts && Object.keys(osMounts).length > 0 ? osMounts[fs] || false : null;
                    line.splice(0, ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : 5);
...
"[project]/node_modules/systeminformation/lib/network.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
                        ...
                        for(let dev in ifaces){
                            ...
                            if (({}).hasOwnProperty.call(ifaces, dev)) {
                                ...
                                ifaces[dev].forEach((details)=>{
                                    ...
                                    if (mac.indexOf('00:00:0') > -1 && (_linux || _darwin) && !details.internal && nodeMainVersion >= 8 && nodeMainVersion <= 11) //TURBOPACK unreachable
                                    ;
                                });
...
"[project]/node_modules/systeminformation/lib/wifi.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/systeminformation/lib/processes.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
function processes(callback) {
    ...
    function parseLine(line) {
        ...
        checkColumn(8);
        const started = ("TURBOPACK compile-time truthy", 1) ? parseElapsedTime(line.substring(parsedhead[8].from + offset, parsedhead[8].to + offset2).trim()) : "TURBOPACK unreachable";
        checkColumn(9);
        ...
        return {
            pid: pid,
            parentPid: ppid,
            name: ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : command,
            cpu: cpu,
            cpuu: 0,
            cpus: 0,
            mem: mem,
...
"[project]/node_modules/systeminformation/lib/users.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/systeminformation/lib/internet.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/systeminformation/lib/dockerSocket.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const isWin = __turbopack_context__.r("[externals]/os [external] (os, cjs)").type() === 'Windows_NT';
...
"[project]/node_modules/systeminformation/lib/docker.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
// ----------------------------------------------------------------------------------
const util = __turbopack_context__.r("[project]/node_modules/systeminformation/lib/util.js [app-route] (ecmascript)");
const DockerSocket = __turbopack_context__.r("[project]/node_modules/systeminformation/lib/dockerSocket.js [app-route] (ecmascript)");
const _platform = process.platform;
const _windows = _platform === 'win32';
...
"[project]/node_modules/systeminformation/lib/virtualbox.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/systeminformation/lib/printer.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/systeminformation/lib/usb.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/systeminformation/lib/audio.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/systeminformation/lib/bluetoothVendors.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/systeminformation/lib/bluetooth.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const path = __turbopack_context__.r("[externals]/path [external] (path, cjs)");
const util = __turbopack_context__.r("[project]/node_modules/systeminformation/lib/util.js [app-route] (ecmascript)");
const bluetoothVendors = __turbopack_context__.r("[project]/node_modules/systeminformation/lib/bluetoothVendors.js [app-route] (ecmascript)");
const fs = __turbopack_context__.r("[externals]/fs [external] (fs, cjs)");
const _platform = process.platform;
const _linux = _platform === 'linux' || _platform === 'android';
const _darwin = _platform === 'darwin';
...
"[project]/node_modules/systeminformation/lib/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
// Dependencies
// ----------------------------------------------------------------------------------
const lib_version = __turbopack_context__.r("[project]/node_modules/systeminformation/package.json (json)").version;
const util = __turbopack_context__.r("[project]/node_modules/systeminformation/lib/util.js [app-route] (ecmascript)");
const system = __turbopack_context__.r("[project]/node_modules/systeminformation/lib/system.js [app-route] (ecmascript)");
const osInfo = __turbopack_context__.r("[project]/node_modules/systeminformation/lib/osinfo.js [app-route] (ecmascript)");
const cpu = __turbopack_context__.r("[project]/node_modules/systeminformation/lib/cpu.js [app-route] (ecmascript)");
const memory = __turbopack_context__.r("[project]/node_modules/systeminformation/lib/memory.js [app-route] (ecmascript)");
const battery = __turbopack_context__.r("[project]/node_modules/systeminformation/lib/battery.js [app-route] (ecmascript)");
const graphics = __turbopack_context__.r("[project]/node_modules/systeminformation/lib/graphics.js [app-route] (ecmascript)");
const filesystem = __turbopack_context__.r("[project]/node_modules/systeminformation/lib/filesystem.js [app-route] (ecmascript)");
const network = __turbopack_context__.r("[project]/node_modules/systeminformation/lib/network.js [app-route] (ecmascript)");
const wifi = __turbopack_context__.r("[project]/node_modules/systeminformation/lib/wifi.js [app-route] (ecmascript)");
const processes = __turbopack_context__.r("[project]/node_modules/systeminformation/lib/processes.js [app-route] (ecmascript)");
const users = __turbopack_context__.r("[project]/node_modules/systeminformation/lib/users.js [app-route] (ecmascript)");
const internet = __turbopack_context__.r("[project]/node_modules/systeminformation/lib/internet.js [app-route] (ecmascript)");
const docker = __turbopack_context__.r("[project]/node_modules/systeminformation/lib/docker.js [app-route] (ecmascript)");
const vbox = __turbopack_context__.r("[project]/node_modules/systeminformation/lib/virtualbox.js [app-route] (ecmascript)");
const printer = __turbopack_context__.r("[project]/node_modules/systeminformation/lib/printer.js [app-route] (ecmascript)");
const usb = __turbopack_context__.r("[project]/node_modules/systeminformation/lib/usb.js [app-route] (ecmascript)");
const audio = __turbopack_context__.r("[project]/node_modules/systeminformation/lib/audio.js [app-route] (ecmascript)");
const bluetooth = __turbopack_context__.r("[project]/node_modules/systeminformation/lib/bluetooth.js [app-route] (ecmascript)");
const _platform = process.platform;
const _windows = _platform === 'win32';
const _freebsd = _platform === 'freebsd';
const _openbsd = _platform === 'openbsd';
...
//# sourceMappingURL=node_modules_systeminformation_6110db75._.js.map