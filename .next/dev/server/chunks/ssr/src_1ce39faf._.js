...
async function Icon() {
    ...
    try {
        // Fetch system config
        // @ts-ignore
        const config = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].systemConfig.findUnique({
            where: {
                id: "default"
            }
        });
...
async function __TURBOPACK__default__export__(props) {
    ...
    function getImageMetadata(imageMetadata, idParam) {
        const data = {
            ...
            url: imageUrl + (idParam ? '/' + idParam : '') + "?6b55c4870d2fc11b"
        };
...
//# sourceMappingURL=src_1ce39faf._.js.map