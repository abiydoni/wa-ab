module.exports = [
"[project]/node_modules/node-webpmux/io.js [app-rsc] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
if ("TURBOPACK compile-time truthy", 1) {
    ...
    const { basename } = __turbopack_context__.r("[externals]/path [external] (path, cjs)");
    fs = {
...
"[project]/node_modules/node-webpmux/parser.js [app-rsc] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
/*
    ...
    MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
    GNU Lesser General Public License for more details.
*/ const IO = __turbopack_context__.r("[project]/node_modules/node-webpmux/io.js [app-rsc] (ecmascript)");
...
function VP8LHeight(data) {
    return ((data[4] << 16 | data[3] << 8 | data[2]) >> 6 & 0b0011111111111111) + 1;
}
...
class WebPWriter {
    ...
    updateChunk_VP8X_size(width1, height1) {
        this.vp8x.writeUIntLE(width1, 12, 3);
        this.vp8x.writeUIntLE(height1, 15, 3);
    }
...
"[project]/node_modules/node-webpmux/libwebp/libwebp.js [app-rsc] (ecmascript)", ((__turbopack_context__, module, exports) => {

var LibWebP = (()=>{
    var _scriptDir = typeof document !== 'undefined' && document.currentScript ? document.currentScript.src : undefined;
    if (typeof ("TURBOPACK compile-time value", "/ROOT/node_modules/node-webpmux/libwebp/libwebp.js") !== 'undefined') _scriptDir = _scriptDir || ("TURBOPACK compile-time value", "/ROOT/node_modules/node-webpmux/libwebp/libwebp.js");
    return function(LibWebP) {
        LibWebP = LibWebP || {};
        var Module = typeof LibWebP != "undefined" ? LibWebP : {};
        ...
        if (ENVIRONMENT_IS_NODE) {
            if (ENVIRONMENT_IS_WORKER) {
                ...
                scriptDirectory = ("TURBOPACK compile-time value", "/ROOT/node_modules/node-webpmux/libwebp") + "/";
            }
            requireNodeFS = ()=>{
                if (!nodePath) {
        ...
        var dynCall_jiiiii = Module["dynCall_jiiiii"] = function() {
            return (dynCall_jiiiii = Module["dynCall_jiiiii"] = Module["asm"]["H"]).apply(null, arguments);
        };
        Module["cwrap"] = cwrap;
        var calledRun;
...
if ("TURBOPACK compile-time truthy", 1) module.exports = LibWebP;
else //TURBOPACK unreachable
;
}),
"[project]/node_modules/node-webpmux/libwebp.js [app-rsc] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
/*
    ...
    MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
    GNU Lesser General Public License for more details.
*/ const libwebpF = __turbopack_context__.r("[project]/node_modules/node-webpmux/libwebp/libwebp.js [app-rsc] (ecmascript)");
const ranges = {
    preset: {
        n: 0,
        m: 5
...
function checkOpts(o) {
    for(let i = 0, keys = Object.keys(o), l = keys.length; i < l; i++){
        ...
        if (o[key] < r.n || o[key] > r.m) {
            throw new Error(`${key} out of range ${r.n}..${r.m}`);
        }
    }
}
function checkAdv(adv) {
    for(let i = 0, keys = Object.keys(adv), l = keys.length; i < l; i++){
        ...
        if (adv[key] < r.n || adv[key] > r.m) {
            throw new Error(`advanced.${key} out of range ${r.n}..${r.m}`);
        }
    }
}
module.exports = class libWebP {
    ...
    async init() {
        ...
        this.api.decodeRGBA = Module.cwrap('decodeRGBA', 'number', [
            'number',
            'number'
        ]);
        this.api.decodeFree = Module.cwrap('decodeFree', '', [
            'number'
        ]);
        this.api.allocBuffer = Module.cwrap('allocBuffer', 'number', [
            'number'
        ]);
        this.api.destroyBuffer = Module.cwrap('destroyBuffer', '', [
            'number'
        ]);
    }
    initEnc() {
...
"[project]/node_modules/node-webpmux/webp.js [app-rsc] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
const { WebPReader, WebPWriter } = __turbopack_context__.r("[project]/node_modules/node-webpmux/parser.js [app-rsc] (ecmascript)");
const IO = __turbopack_context__.r("[project]/node_modules/node-webpmux/io.js [app-rsc] (ecmascript)");
...
class Image {
    ...
    async _demuxFrame(d, frame) {
        let { hasICCP, hasEXIF, hasXMP } = this.data.extended ? this.data.extended : {
            hasICCP: false,
            hasEXIF: false,
            hasXMP: false
        }, hasAlpha = frame.vp8 && frame.vp8.alpha, writer = new WebPWriter();
        if (typeof d === 'string') {
            writer.writeFile(d);
        } else {
            writer.writeBuffer();
    ...
    async _save(writer, { width = undefined, height = undefined, frames = undefined, bgColor = [
        255,
        255,
        255,
        255
    ], loops = 0, delay = 100, x = 0, y = 0, blend = true, dispose = false, exif = false, iccp = false, xmp = false } = {}) {
    ...
    async save(path = this.path, { width = this.width, height = this.height, frames = this.frames, bgColor = this.hasAnim ? this.anim.bgColor : [
        255,
        255,
        255,
        255
    ], loops = this.hasAnim ? this.anim.loops : 0, delay = 100, x = 0, y = 0, blend = true, dispose = false, exif = !!this.exif, iccp = !!this.iccp, xmp = !!this.xmp } = {}) {
    ...
    async setImageData(buf, { width = 0, height = 0, preset = undefined, quality = undefined, exact = undefined, lossless = undefined, method = undefined, advanced = undefined } = {}) {
        ...
        let ret = Image.libwebp.encodeImage(buf, width > 0 ? width : this.width, height > 0 ? height : this.height, {
            preset,
            quality,
            exact,
            lossless,
    ...
    async setFrameData(frameIndex, buf, { width = 0, height = 0, preset = undefined, quality = undefined, exact = undefined, lossless = undefined, method = undefined, advanced = undefined } = {}) {
        ...
        let fr = this.frames[frameIndex], ret = Image.libwebp.encodeImage(buf, width > 0 ? width : fr.width, height > 0 ? height : fr.height, {
            preset,
            quality,
            exact,
            lossless,
    ...
    static async initLib() {
        if (!Image.libwebp) {
            const libWebP = __turbopack_context__.r("[project]/node_modules/node-webpmux/libwebp.js [app-rsc] (ecmascript)");
...
//# sourceMappingURL=node_modules_node-webpmux_e87d29b6._.js.map