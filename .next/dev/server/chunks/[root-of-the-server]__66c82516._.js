...
"[project]/src/app/api/sessions/[sessionId]/[action]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request, { params }) {
    try {
        ...
        switch(action){
            case "pair":
                ...
                if (!phoneNumber) {
                    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                        status: false,
                        message: "Phone number required for pairing"
                    }, {
                        status: 400
                    });
                }
                const pairingCode = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$whatsapp$2f$manager$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["waManager"].requestPairingCode(sessionId, phoneNumber);
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    status: true,
            ...
            case "start":
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$whatsapp$2f$manager$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["waManager"].startSession(sessionId);
                break;
            case "stop":
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$whatsapp$2f$manager$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["waManager"].stopSession(sessionId);
                break;
            case "restart":
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$whatsapp$2f$manager$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["waManager"].restartSession(sessionId);
                break;
            case "logout":
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: `Failed to ${error.message || "perform action"}`
        }, {
            status: 500
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__66c82516._.js.map