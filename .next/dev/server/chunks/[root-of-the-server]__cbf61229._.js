...
"[project]/src/app/api/groups/[sessionId]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        // Try to force a live sync from Baileys if the socket is connected
        ...
        if (instance?.socket) {
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$whatsapp$2f$store$2f$groups$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["syncGroups"])(instance.socket, sessionId);
            } catch (e) {
                console.error("Live group sync failed: ", e);
            }
        }
        const groups = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].group.findMany({
            where: {
                sessionId: session.id
            },
            orderBy: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cbf61229._.js.map