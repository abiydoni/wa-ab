...
"[project]/src/app/api/webhooks/[sessionId]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    ...
    const hasAccess = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["canAccessSession"])(user.id, user.role, sessionId);
    if (!hasAccess) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: false,
...
async function POST(request, { params }) {
    ...
    try {
        ...
        const webhook = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].webhook.create({
            data: {
                userId: user.id,
                name,
                url,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3d2f28a4._.js.map