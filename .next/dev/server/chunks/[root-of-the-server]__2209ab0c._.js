...
"[project]/src/lib/swagger.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
// @ts-nocheck
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$swagger$2d$doc$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/next-swagger-doc/dist/index.js [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$swagger$2d$doc$2f$dist$2f$swagger$2d$DVmBaJxy$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__c__as__createSwaggerSpec$3e$__ = __turbopack_context__.i("[project]/node_modules/next-swagger-doc/dist/swagger-DVmBaJxy.js [app-route] (ecmascript) <export c as createSwaggerSpec>");
;
const getApiDocs = ()=>{
    const spec = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$swagger$2d$doc$2f$dist$2f$swagger$2d$DVmBaJxy$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__c__as__createSwaggerSpec$3e$__["createSwaggerSpec"])({
        apiFolder: "src/app/api",
        definition: {
            openapi: "3.0.0",
            info: {
                title: "WA-AB API Documentation",
                version: "1.2.0",
                description: `
...
- Message history: Max 100 messages
            ...
            servers: [
                {
                    url: ("TURBOPACK compile-time value", "http://localhost:3000/api") || "http://localhost:3000/api",
            ...
            paths: {
                                    ...
                                    schema: {
                                        ...
                                        properties: {
                                            ...
                                            delay: {
                                                ...
                                                maximum: 60000,
                                                default: 2000,
                                                description: "Intended delay between messages (ms). Note: implementation uses additional random 10-20s delay."
                                            }
                                        }
                                    }
                                }
                ...
                "/messages/poll": {
                    post: {
                        ...
                        responses: {
                            ...
                            400: {
                                description: "Invalid request (missing fields or options out of range)"
                            },
                            401: {
                                $ref: "#/components/responses/Unauthorized"
                            },
                ...
                "/messages/location": {
                    post: {
                        ...
                        responses: {
                            ...
                            400: {
                                description: "Invalid request (missing fields or coordinates out of range)"
                            },
                            401: {
                                $ref: "#/components/responses/Unauthorized"
                            },
                ...
                "/messages/contact": {
                    post: {
                        ...
                        responses: {
                            ...
                            400: {
                                description: "Invalid request (missing fields or empty contacts)"
                            },
                            401: {
                                $ref: "#/components/responses/Unauthorized"
                            },
                ...
                "/messages/list": {
                    post: {
                        ...
                        responses: {
                            ...
                            400: {
                                description: "Missing fields or empty options"
                            },
                            401: {
                                $ref: "#/components/responses/Unauthorized"
                            },
                                    ...
                                    "application/json": {
                                        schema: {
                                            ...
                                            properties: {
                                                ...
                                                message: {
                                                    type: "string",
                                                    example: "Bombing 5 messages started"
                                                }
                                            }
                                        }
                                    }
                                ...
                                "multipart/form-data": {
                                    schema: {
                                        ...
                                        properties: {
                                            ...
                                            pack: {
                                                type: "string",
                                                description: "Sticker pack name (default: WA-AB)"
                                            },
                                            author: {
                                                type: "string",
                ...
                "/messages/forward": {
                    post: {
                        ...
                        responses: {
                                    ...
                                    "application/json": {
                                        schema: {
                                            ...
                                            properties: {
                                                ...
                                                message: {
                                                    type: "string",
                                                    example: "Message forwarded to 1 recipient(s)"
                                                }
                                            }
                                        }
                                    }
                            ...
                            400: {
                                description: "Invalid request (missing fields or empty recipients)"
                            },
                            401: {
                                $ref: "#/components/responses/Unauthorized"
                            },
                ...
                "/messages/delete": {
                    delete: {
                        ...
                        responses: {
                            ...
                            400: {
                                description: "Message too old (> 7 minutes) or missing fields"
                            },
                            401: {
                                $ref: "#/components/responses/Unauthorized"
                            },
                ...
                "/groups/{jid}/invite": {
                                    ...
                                    "application/json": {
                                        schema: {
                                            ...
                                            properties: {
                                                ...
                                                inviteUrl: {
                                                    type: "string",
                                                    example: "https://chat.whatsapp.com/AbCdEfGh"
                                                }
                                            }
                                        }
                                    }
                    ...
                    put: {
                        ...
                        responses: {
                            200: {
                                description: "Invite code revoked, new code generated"
                            }
                        }
                    }
                },
                    ...
                    get: {
                        ...
                        parameters: [
                            ...
                            },
                            {
                                ...
                                description: "Search by name, notify, jid"
                            }
                        ],
                        responses: {
                            200: {
                                ...
                                "application/json": {
                                    schema: {
                                        ...
                                        properties: {
                                            ...
                                            response: {
                                                type: "string",
                                                example: "Our prices start at $10"
                                            },
                                            matchType: {
                                                type: "string",
                                                enum: [
                ...
                "/autoreplies/{id}": {
                    get: {
                        ...
                        responses: {
                            200: {
                                description: "Auto-reply rule details"
                            }
                        }
                    },
                    put: {
                ...
                "/groups/{jid}/ephemeral": {
                    put: {
                                    ...
                                    schema: {
                                        ...
                                        properties: {
                                            ...
                                            expiration: {
                                                ...
                                                description: "0 (off), 86400 (24h), 604800 (7d), 7776000 (90d)"
                                            }
                                        }
                                    }
                                }
                        ...
                        responses: {
                            200: {
                                description: "Ephemeral settings updated"
                            }
                        }
                    }
                },
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$swagger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/swagger.ts [app-route] (ecmascript)");
;
;
async function GET() {
    const spec = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$swagger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getApiDocs"])();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2209ab0c._.js.map